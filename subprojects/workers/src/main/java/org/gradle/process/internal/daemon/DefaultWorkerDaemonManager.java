 ...
 */
@ThreadSafe
public class DefaultWorkerDaemonManager implements WorkerDaemonManager, Stoppable {
    ...
    public DefaultWorkerDaemonManager(WorkerDaemonClientsManager clientsManager, MemoryManager memoryManager) {
