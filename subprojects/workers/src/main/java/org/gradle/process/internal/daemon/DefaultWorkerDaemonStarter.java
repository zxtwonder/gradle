...
public class DefaultWorkerDaemonStarter implements WorkerDaemonStarter {
    private final static Logger LOG = Logging.getLogger(DefaultWorkerDaemonStarter.class);
    private final WorkerProcessFactory workerFactory;
    private final StartParameter startParameter;

    public DefaultWorkerDaemonStarter(WorkerProcessFactory workerFactory, StartParameter startParameter) {
    ...
    public WorkerDaemonClient startDaemon(Class<? extends WorkerDaemonProtocol> serverImplementationClass, File workingDir, DaemonForkOptions forkOptions) {
        ...
        WorkerDaemonClient client = new WorkerDaemonClient(forkOptions, worker, workerProcess);
