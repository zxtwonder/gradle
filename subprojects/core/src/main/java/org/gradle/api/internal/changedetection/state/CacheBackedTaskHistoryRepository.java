...
public class CacheBackedTaskHistoryRepository implements TaskHistoryRepository {
    ...
    public CacheBackedTaskHistoryRepository(TaskHistoryStore cacheAccess, FileSnapshotRepository snapshotRepository, TaskExecutionListSerializer serializer, StringInterner stringInterner) {
        this.snapshotRepository = snapshotRepository;
        this.serializer = serializer;
        this.stringInterner = stringInterner;
        taskHistoryCache = cacheAccess.createCache("taskHistory", String.class, this.serializer, 2000, false);
    }
