...
public class DefaultPlayToolChain implements PlayToolChainInternal {
    ...
    private SessionWorkerDaemonManager compilerDaemonManager;
    private final ConfigurationContainer configurationContainer;
    private final DependencyHandler dependencyHandler;
    private final WorkerProcessFactory workerProcessBuilderFactory;

    public DefaultPlayToolChain(FileResolver fileResolver, SessionWorkerDaemonManager compilerDaemonManager, ConfigurationContainer configurationContainer, DependencyHandler dependencyHandler, WorkerProcessFactory workerProcessBuilderFactory) {
