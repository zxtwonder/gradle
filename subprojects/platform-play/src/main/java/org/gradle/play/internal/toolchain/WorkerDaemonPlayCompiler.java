...
public class WorkerDaemonPlayCompiler<T extends PlayCompileSpec> extends AbstractWorkerCompiler<T> {
    ...
    public WorkerDaemonPlayCompiler(Compiler<T> compiler, WorkerExecutor workerExecutor, Iterable<File> compilerClasspath, Iterable<String> classLoaderPackages) {
        super(compiler, workerExecutor, ForkMode.ALWAYS);
