...
public class DownloadingScalaToolChain implements ScalaToolChainInternal {
    ...
    public DownloadingScalaToolChain(File gradleUserHomeDir, File rootProjectDir, SessionWorkerDaemonManager compilerDaemonManager, ConfigurationContainer configurationContainer, DependencyHandler dependencyHandler) {
