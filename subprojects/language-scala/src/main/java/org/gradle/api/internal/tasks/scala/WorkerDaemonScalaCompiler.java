...
public class WorkerDaemonScalaCompiler<T extends ScalaJavaJointCompileSpec> extends AbstractWorkerCompiler<T> {
    ...
    public WorkerDaemonScalaCompiler(Compiler<T> delegate, WorkerExecutor workerExecutor, Iterable<File> zincClasspath) {
        super(delegate, workerExecutor, ForkMode.ALWAYS);
